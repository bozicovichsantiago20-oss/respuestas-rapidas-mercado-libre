# Respuestas rapidas para Mercado Libre

Ejemplos listos para vendedores que reciben preguntas repetidas sobre stock, envio, precio, medidas, garantia, factura, cambios y reclamos.
...
Hola. Tenemos stock disponible de [producto]. Podes comprar directamente desde la publicacion y la compra confirma la reserva.

### Envio

Hola. Despachamos en [plazo]. La fecha final la informa la plataforma segun tu zona antes de pagar.

### Precio

Hola. El precio vigente es el publicado. Si hay promocion activa, aparece aplicada antes de pagar.

### Reclamo

Hola. Lamentamos el inconveniente. Enviame foto/video, detalle y numero de compra para revisar el caso.
